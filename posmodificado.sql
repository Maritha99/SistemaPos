...
-- Tiempo de generación: 30-01-2023 a las 20:37:40
...
(42, 11, 3, 'LB-00012', 'Labial HydraLipRojo ', 'vistas/img/productos/LB-00012/320.jpg', 4, 20, 30),
(43, 11, 3, 'LB-00013', 'Labial Hydralip', 'vistas/img/productos/LB-00013/220.png', 31, 30, 35),
...
INSERT INTO `ventass` (`id`, `codigo`, `idvendedor`, `idcliente`, `cantidadproductos`, `total`, `metodo_pago`, `fecha`) VALUES
(30, 10001, 9, 7, '[{\"id\":\"42\",\"descripcion\":\"Labial HydraLipRojo \",\"cantidad\":\"1\",\"stock\":\"12\",\"precio\":\"30\",\"total\":\"30\"},{\"id\":\"43\",\"descripcion\":\"Labial Hydralip\",\"cantidad\":\"1\",\"stock\":\"33\",\"precio\":\"35\",\"total\":\"35\"}]', 65, 'Efectivo', '2022-06-30 19:56:46'),
(31, 10002, 9, 6, '[{\"id\":\"42\",\"descripcion\":\"Labial HydraLipRojo \",\"cantidad\":\"7\",\"stock\":\"4\",\"precio\":\"30\",\"total\":\"210\"},{\"id\":\"43\",\"descripcion\":\"Labial Hydralip\",\"cantidad\":\"1\",\"stock\":\"32\",\"precio\":\"35\",\"total\":\"35\"}]', 245, 'Efectivo', '2022-08-30 20:07:15'),
(32, 10003, 9, 6, '[{\"id\":\"41\",\"descripcion\":\"Labial Crude Nude\",\"cantidad\":\"4\",\"stock\":\"32\",\"precio\":\"20\",\"total\":\"80\"},{\"id\":\"42\",\"descripcion\":\"Labial HydraLipRojo \",\"cantidad\":\"1\",\"stock\":\"10\",\"precio\":\"30\",\"total\":\"30\"}]', 110, 'Efectivo', '2022-08-30 20:06:46'),
(33, 10004, 11, 8, '[{\"id\":\"41\",\"descripcion\":\"Labial Crude Nude\",\"cantidad\":\"1\",\"stock\":\"31\",\"precio\":\"20\",\"total\":\"20\"},{\"id\":\"43\",\"descripcion\":\"Labial Hydralip\",\"cantidad\":\"1\",\"stock\":\"31\",\"precio\":\"35\",\"total\":\"35\"}]', 55, 'Efectivo', '2022-08-30 20:10:24');
...
ALTER TABLE `administrador`
  ADD KEY `fk_administrador_empleado` (`idempleado`),
...
--
ALTER TABLE `administrador`
  ADD CONSTRAINT `fk_administrador_empleado` FOREIGN KEY (`idempleado`) REFERENCES `empleados` (`idempleado`),
  ADD CONSTRAINT `fk_administrador_usuario` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`);
