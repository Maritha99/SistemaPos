...
<head>
  ...
  <!-- plantilla agregada de boostrap5-->
  ...
  <!-- Bootstrap 5 de javascript -->
  <script src="vistas/bower_components/bootstrap/dist/js/bootstrap.min.js"></script> <!--YAESTA_->
